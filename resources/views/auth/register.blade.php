            ...
            <div class="col-12 col-md-8">
                <form action="{{route('register')}}" method="POST" class="card p-5 shadow">
                    ...
                    <div class="mb-3">
                        ...
                        <input typle="text" class="form-control" id="name" name="name" value="{{old('name')}}">
                        @error('name')
                    ...
                    <div class="mb-3 d-flex justify-content-center flex-column align-items-center">
                        ...
                        <p class="mt-2">Sei già registrato? <a href="{{route('login'}}" class="text-secondary">Clicca qui</a>
                    </div>
                </form>
            </div>
        </div>
